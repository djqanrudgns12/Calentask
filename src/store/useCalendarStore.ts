...
export type ViewMode = 'home' | 'monthly' | 'weekly' | 'list' | 'semester' | 'nice_import' | 'anniversary' | 'google_sync' | 'school_meals' | 'insights' | 'archive_notes' | 'archive_agenda' | 'link_lounge' | 'tags' | 'trash' | 'template_center'
